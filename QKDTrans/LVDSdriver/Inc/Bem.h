...
#if defined(IOP_CODE)           // The following is used only by Local code
...
typedef struct _BEM_INIT_PARAMS
{
    ...
    U16     PlxChipType;                // PLX Chip type
    ADDRESS PlxAddress;                 // Local bus address of PLX config. registers
    ADDRESS FlashAddress;               // Local bus address of FLASH
    ADDRESS FlashBufferAddress;         // Local bus address of temp FLASH buffer
