...
typedef enum _DRIVER_MSGS
{
    ...
    MSG_MU_OUTINDEX_READ,
    MSG_MU_OUTINDEX_WRITE,
    MSG_DMA_CONTROL,
    MSG_DMA_STATUS,
...
#define PLX_IOCTL_MU_OUTINDEX_READ              IOCTL_MSG( MSG_MU_OUTINDEX_READ )
#define PLX_IOCTL_MU_OUTINDEX_WRITE             IOCTL_MSG( MSG_MU_OUTINDEX_WRITE )
